...
Data<-GlobalDriversFire.dt[Year!=2016 & Biomes==13,]
...
#Correlations
#PopDensity_log with LC_Crop, TMax with PET and LAI with fPAR, drop LAI and PET and LC_Crop
...
f2<-formula(Ignitions~IDL_Layer*LC_Tree+IDL_Layer*LC_Shrub+IDL_Layer*LC_Herbs
            +IDL_Layer*DTR+IDL_Layer*TMax+IDL_Layer*fPAR+IDL_Layer*Precipitation+ IDL_Layer*NrWetDays+IDL_Layer*RoadDensity_sqrt+IDL_Layer*PopDensity_log+IDL_Layer*DistUrbPop)
...
#-> Homogenity might be violated (trend in data) but looks ok, normality of the residuals looks ok, no outliers

#save the complete model output
#set path
setwd("~/GitHub/GLM-Drivers-of-Fire/Output/Model Results")
saveRDS(LMfinal, "LMBiome13Ignitions.rds")
...
M.gls10 <- gls(f, data =Data,
              weights = vf10)
AIC(GLM,M.gls1,M.gls2,M.gls3,M.gls5,M.gls6,M.gls7, M.gls8, M.gls9, M.gls10)
...
vf11 <- varComb(
  varExp(form =~RoadDensity_sqrt),
  varExp(form =~PopDensity_log),
  varExp(form =~DistUrbPop),
               varExp(form =~fPAR))
...
AIC(GLM,M.gls2,M.gls3,M.gls5,M.gls6,M.gls7, M.gls8, M.gls9, M.gls10, M.glsw)
...
AIC(GLM,M.gls2,M.gls3,M.gls5,M.gls6,M.gls7, M.gls8, M.gls9, M.gls10, M.glsw,M.glswc) #considerably better
summary(M.glswc)
...
#drop IDL_LayerNo_IDL:I(DistUrbPop^2) & IDL_LayerNo_IDL:I(RoadDensity_sqrt^2) & IDL_LayerNo_IDL:I(fPAR^2) & IDL_LayerNo_IDL:DistUrbPop
ffix1<-formula(Ignitions~IDL_Layer*LC_Tree+IDL_Layer*LC_Shrub+IDL_Layer*LC_Herbs
               +IDL_Layer*DTR+IDL_Layer*TMax+IDL_Layer*fPAR+IDL_Layer*Precipitation+IDL_Layer*NrWetDays +IDL_Layer*RoadDensity_sqrt+IDL_Layer*PopDensity_log+DistUrbPop
               +IDL_Layer*I(TMax^2)+IDL_Layer*I(DTR^2)+I(fPAR^2)+ IDL_Layer*I(LC_Tree^2) +IDL_Layer*I(LC_Shrub^2)+IDL_Layer*I(LC_Herbs^2)+IDL_Layer*I(Precipitation^2) +IDL_Layer*I(NrWetDays^2)
               +I(RoadDensity_sqrt^2)+IDL_Layer*I(PopDensity_log^2)+I(DistUrbPop^2)
)
...
ffix2<-formula(Ignitions~IDL_Layer*LC_Tree+IDL_Layer*LC_Shrub+IDL_Layer*LC_Herbs
               +IDL_Layer*DTR+IDL_Layer*TMax+IDL_Layer*fPAR+IDL_Layer*Precipitation+IDL_Layer*NrWetDays +IDL_Layer*RoadDensity_sqrt+IDL_Layer*PopDensity_log
               +IDL_Layer*I(TMax^2)+IDL_Layer*I(DTR^2)+I(fPAR^2)+ IDL_Layer*I(LC_Tree^2) +IDL_Layer*I(LC_Shrub^2)+IDL_Layer*I(LC_Herbs^2)+IDL_Layer*I(Precipitation^2) +IDL_Layer*I(NrWetDays^2)
               +I(RoadDensity_sqrt^2)+IDL_Layer*I(PopDensity_log^2)+I(DistUrbPop^2)
)
...
#set path
setwd("~/GitHub/GLM-Drivers-of-Fire/Output/Model Results")
saveRDS(M.glswc, "lmeBiome13Ignitions.rds")
...
sf<-formula(Ignitions~IDL_Layer+s(LC_Tree)+s(LC_Shrub)+s(LC_Herbs)
...
#set path
setwd("~/GitHub/GLM-Drivers-of-Fire/Output/Model Results")
saveRDS(GAM, "GAMBiome13Ignitions.rds")
#test<- readRDS("lmeBiome7.rds")
