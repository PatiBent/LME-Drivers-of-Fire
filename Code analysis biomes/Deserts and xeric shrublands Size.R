...
range(Data$LC_Crop)
plotNormalHistogram(sqrt(Data$LC_Crop))
plotNormalHistogram(sign(Data$LC_Crop)*abs(Data$LC_Crop)^(1/3))
plotNormalHistogram(log(Data$LC_Crop+1))
...
plotNormalHistogram(sqrt(Data$PopDensity))
...
saveRDS(LMfinal, "LMBiome13Size.rds")

#-> Homogenity might be violated (trend), normality of the residuals looks good, no outliers
...
#compare AIC
AIC(GLM,M.gls1,M.gls2,M.gls3,M.gls5,M.gls6,M.gls7, M.gls8, M.gls9, M.gls10, M.glsw)
...
AIC(GLM,M.gls1,M.gls2,M.gls3,M.gls5,M.gls6,M.gls7, M.gls8, M.gls9, M.gls10, M.glsw,M.glswc) #considerably better
summary(M.glswc)
...
#drop IDL_LayerNo_IDL:I(PopDensity_log^2) & IDL_LayerNo_IDL:I(NrWetDays^2) & IDL_LayerNo_IDL:NrWetDays 
ffix1<-formula(Size~IDL_Layer*LC_Tree+IDL_Layer*LC_Shrub+IDL_Layer*LC_Herbs
                  +IDL_Layer*DTR+IDL_Layer*TMax+IDL_Layer*fPAR+IDL_Layer*Precipitation+NrWetDays +IDL_Layer*RoadDensity_sqrt+IDL_Layer*PopDensity_log+IDL_Layer*DistUrbPop
                  +IDL_Layer*I(TMax^2)+IDL_Layer*I(DTR^2)+IDL_Layer*I(fPAR^2)+ IDL_Layer*I(LC_Tree^2) +IDL_Layer*I(LC_Shrub^2)+IDL_Layer*I(LC_Herbs^2)+IDL_Layer*I(Precipitation^2) +I(NrWetDays^2)
                  +IDL_Layer*I(RoadDensity_sqrt^2)+I(PopDensity_log^2)+IDL_Layer*I(DistUrbPop^2)
)
...
#drop I(NrWetDays^2)      
ffix2<-formula(Size~IDL_Layer*LC_Tree+IDL_Layer*LC_Shrub+IDL_Layer*LC_Herbs
               +IDL_Layer*DTR+IDL_Layer*TMax+IDL_Layer*fPAR+IDL_Layer*Precipitation+NrWetDays +IDL_Layer*RoadDensity_sqrt+IDL_Layer*PopDensity_log+IDL_Layer*DistUrbPop
               +IDL_Layer*I(TMax^2)+IDL_Layer*I(DTR^2)+IDL_Layer*I(fPAR^2)+ IDL_Layer*I(LC_Tree^2) +IDL_Layer*I(LC_Shrub^2)+IDL_Layer*I(LC_Herbs^2)+IDL_Layer*I(Precipitation^2) 
               +IDL_Layer*I(RoadDensity_sqrt^2)+I(PopDensity_log^2)+IDL_Layer*I(DistUrbPop^2)
)
...
#set path
setwd("~/GitHub/GLM-Drivers-of-Fire/Output/Model Results")
saveRDS(M.glswc, "lmeBiome13Size.rds")
...
sf<-formula(Size~IDL_Layer+s(LC_Tree)+s(LC_Shrub)+s(LC_Herbs)
...
#set path
setwd("~/GitHub/GLM-Drivers-of-Fire/Output/Model Results")
saveRDS(GAM, "GAMBiome13Size.rds")
#test<- readRDS("lmeBiome7.rds")
