...
saveRDS(LMfinal, "LMBiome8Ignitions.rds")
...
#drop IDL_LayerNo_IDL:I(RoadDensity_sqrt^2) & IDL_LayerNo_IDL:DTR & IDL_LayerNo_IDL:LC_Herbs
ffix1<-formula(Ignitions~IDL_Layer*LC_Tree+IDL_Layer*LC_Shrub+LC_Herbs
...
#drop PopDensity_log  
ffix2<-formula(Ignitions~IDL_Layer*LC_Tree+IDL_Layer*LC_Shrub+LC_Herbs
                +DTR+IDL_Layer*TMax+IDL_Layer*fPAR+IDL_Layer*LC_Crop+IDL_Layer*Precipitation+IDL_Layer*NrWetDays +IDL_Layer*RoadDensity_sqrt+IDL_Layer*DistUrbPop
                +IDL_Layer*I(TMax^2)+IDL_Layer*I(DTR^2)+IDL_Layer*I(fPAR^2)+ IDL_Layer*I(LC_Tree^2) +IDL_Layer*I(LC_Shrub^2)+IDL_Layer*I(LC_Crop^2)+IDL_Layer*I(LC_Herbs^2)+IDL_Layer*I(Precipitation^2) +IDL_Layer*I(NrWetDays^2)
                +I(RoadDensity_sqrt^2)+IDL_Layer*I(PopDensity_log^2)+IDL_Layer*I(DistUrbPop^2)
)
...
#drop DistUrbPop  
ffix3<-formula(Ignitions~IDL_Layer*LC_Tree+IDL_Layer*LC_Shrub+LC_Herbs
               +DTR+IDL_Layer*TMax+IDL_Layer*fPAR+IDL_Layer*LC_Crop+IDL_Layer*Precipitation+IDL_Layer*NrWetDays +IDL_Layer*RoadDensity_sqrt+IDL_Layer*PopDensity_log
               +IDL_Layer*I(TMax^2)+IDL_Layer*I(DTR^2)+IDL_Layer*I(fPAR^2)+ IDL_Layer*I(LC_Tree^2) +IDL_Layer*I(LC_Shrub^2)+IDL_Layer*I(LC_Crop^2)+IDL_Layer*I(LC_Herbs^2)+IDL_Layer*I(Precipitation^2) +IDL_Layer*I(NrWetDays^2)
               +I(RoadDensity_sqrt^2)+IDL_Layer*I(PopDensity_log^2)+IDL_Layer*I(DistUrbPop^2)
)
...
#-> Homogenity and normality of the residuals looks very good and ok respectively. Model with the best AIC as well
...
#set path
setwd("~/GitHub/GLM-Drivers-of-Fire/Output/Model Results")
saveRDS(M.glswc, "lmeBiome8Ignitions.rds")
...
#set path
setwd("~/GitHub/GLM-Drivers-of-Fire/Output/Model Results")
saveRDS(GAM, "GAMBiome8Ignitions.rds")
#test<- readRDS("lmeBiome7.rds")
