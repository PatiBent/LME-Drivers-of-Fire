...
#Correlations
#NrWetDays with Precipitation, PET with TMax, LAI and fPAR, drop PET and fPAR and NrWetDays
...
saveRDS(LMfinal, "LMBiome7Duration.rds")
...
#drop IDL_LayerNo IDL:Precipitation 
ffix1<-formula(Duration~IDL_Layer*LC_Tree+LC_Shrub+IDL_Layer*LC_Herbs
           +IDL_Layer*DTR+IDL_Layer*TMax+IDL_Layer*fPAR+IDL_Layer*LC_Crop+Precipitation      +IDL_Layer*RoadDensity_sqrt+PopDensity_log+IDL_Layer*DistUrbPop
           +IDL_Layer*I(TMax^2)+IDL_Layer*I(DTR^2)+IDL_Layer*I(fPAR^2)+ IDL_Layer*I(LC_Tree^2) +IDL_Layer*I(LC_Shrub^2)+IDL_Layer*I(LC_Crop^2)+IDL_Layer*I(LC_Herbs^2)+IDL_Layer*I(Precipitation^2)
           +IDL_Layer*I(RoadDensity_sqrt^2)+IDL_Layer*I(PopDensity_log^2)+IDL_Layer*I(DistUrbPop^2)
)
...
#now we found the model with the best random and fixed structure 
#as the backward selection did not improve the AIC we don't have to refit the model
LME.final<-M.glswc
...
#set path
setwd("~/GitHub/GLM-Drivers-of-Fire/Output/Model Results")
saveRDS(M.glswc, "lmeBiome7Duration.rds")
...
#set path
setwd("~/GitHub/GLM-Drivers-of-Fire/Output/Model Results")
saveRDS(GAM, "GAMBiome7Duration.rds")
#test<- readRDS("lmeBiome7.rds")
