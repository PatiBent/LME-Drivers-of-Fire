#*****************************************************************#
#           Model diagnostic Fire Ignitions                       #
...
Data<-GlobalDriversFire.dt[Year!=2016 & Biomes==4,]
#We only want data were fires are actually possible, so no bare lands
plot(rasterFromXYZ(GlobalDriversFire.dt[,.(x, y,as.numeric(LC_Bare))]),main= "Fire Ignitions ",col=mycolors)
Data<-Data[LC_Bare!=1]
...
colSums(Data!=0)
colSums(Data==0)
#plot some categorical variables and the response variable fire Ignitions
plot(rasterFromXYZ(Data[,.(x, y,as.numeric(Ignitions))]),main= "Fire Ignitions ",col=mycolors) 
plot(rasterFromXYZ(Data[,.(x, y,as.numeric(GFED_Regions))]),main= "Fire Ignitions ",col=mycolors) 
plot(rasterFromXYZ(Data[,.(x, y,as.numeric(Continent))]),main= "Fire Ignitions ",col=mycolors) 
plot(rasterFromXYZ(Data[,.(x, y,as.numeric(IDL_Layer))]),main= "Fire Ignitions ",col=mycolors) 
#view fire Ignitions indigenous vs none indigenous land
plot(rasterFromXYZ(Data[IDL_Layer=="IDL",.(x, y,as.numeric(Ignitions))]),main= "IDL ",col=mycolors)
plot(rasterFromXYZ(Data[IDL_Layer=="No_IDL",.(x, y,as.numeric(Ignitions))]),main= "No IDL  ",col=mycolors)

#View histogram/distribution of response variable and transform if necessary
#Ignitions
summary(Data$Ignitions)
range(Data$Ignitions)
hist(Data$Ignitions) #right skewed
plotNormalHistogram(sqrt(Data$Ignitions))
plotNormalHistogram(sign(Data$Ignitions)*abs(Data$Ignitions)^(1/3))
plotNormalHistogram(log(Data$Ignitions))
plotNormalHistogram(log(Data$Ignitions))
plotNormalHistogram(log10(Data$Ignitions))
Data$Ignitions <- (sign(Data$Ignitions)*abs(Data$Ignitions)^(1/3))
plotNormalHistogram(Data$Ignitions)
...
plot(Ignitions~TMax)
plot(Ignitions~DTR) 
plot(Ignitions~NrWetDays) 
plot(Ignitions~Precipitation) 
plot(Ignitions~PET) 
plot(Ignitions~RoadDensity_sqrt)
plot(Ignitions~PopDensity_log)
plot(Ignitions~DistUrbPop) 
plot(Ignitions~LC_Shrub) 
plot(Ignitions~LC_Tree)  
plot(Ignitions~LC_Crop)  
plot(Ignitions~LC_Herbs)
plot(Ignitions~LAI) 
plot(Ignitions~fPAR) 
detach(Data)
dev.off()
#all looks ok, no need to further transform any data

#View the relationship of all categorical explanatory variables to the response variable
barplot(table(Data$IDL_Layer), ylab = "Frequency", main = "IDL") #heavily skewed towards No IDL
boxplot( Ignitions ~ interaction(IDL_Layer,Month), data=Data )
boxplot( Ignitions ~ interaction(IDL_Layer,Year), data=Data )
boxplot( Ignitions ~ interaction(IDL_Layer,Continent), data=Data )
boxplot( Ignitions ~ interaction(IDL_Layer,GFED_Regions), data=Data )
boxplot( Ignitions ~ IDL_Layer, data=Data )
boxplot( Ignitions ~ Month, data=Data )

#Check for correlations
cor(Data[,c(6:19,28)], use="pairwise.complete.obs")>0.7
#Correlations
#PET with TMax, LAI and fPAR, drop PET and LAI 
...
#1 linear model
f2<-formula(Ignitions~IDL_Layer*LC_Tree+IDL_Layer*LC_Shrub+IDL_Layer*LC_Herbs
...
f<-formula(Ignitions~IDL_Layer*LC_Tree+IDL_Layer*LC_Shrub+IDL_Layer*LC_Herbs
           +IDL_Layer*DTR+IDL_Layer*TMax+IDL_Layer*fPAR+IDL_Layer*LC_Crop+IDL_Layer*Precipitation+IDL_Layer*NrWetDays +IDL_Layer*RoadDensity_sqrt+IDL_Layer*PopDensity_log+IDL_Layer*DistUrbPop
...
#-> Homogenity looks ok, normality of the residuals looks ok, no outliers

#save the complete model output
#set path
setwd("~/GitHub/GLM-Drivers-of-Fire/Output/Model Results")
saveRDS(LMfinal, "LMBiome4Ignitions.rds")
...
M.gls10 <- gls(f, data =Data,
              weights = vf10)
AIC(GLM,M.gls2,M.gls3,M.gls4,M.gls5,M.gls6,M.gls7, M.gls8, M.gls9, M.gls10)
...
M.glsw2 <- gls(f, data =Data,
               weights = vf12)

AIC(GLM,M.gls2,M.gls3,M.gls4,M.gls5,M.gls6,M.gls7, M.gls8, M.gls9, M.gls10, M.glsw, M.glsw2)
...
M.glswc <- lme(f, data =Data,
               random = ~ 1 |GFED_Regions, weights = vf12 )
end_time <- Sys.time()
start_time-end_time

AIC(GLM,M.gls2,M.gls3,M.gls4,M.gls5,M.gls6,M.gls7, M.gls8, M.gls9, M.gls10, M.glsw2,M.glswc) #considerably better
summary(M.glswc)
...
#drop IDL_LayerNo_IDL:I(PopDensity_log^2) & IDL_LayerNo_IDL:I(RoadDensity_sqrt^2) & IDL_LayerNo_IDL:I(LC_Tree^2)          
ffix1<-formula(Ignitions~IDL_Layer*LC_Tree+IDL_Layer*LC_Shrub+IDL_Layer*LC_Herbs
               +IDL_Layer*DTR+IDL_Layer*TMax+IDL_Layer*fPAR+IDL_Layer*LC_Crop+IDL_Layer*Precipitation+IDL_Layer*NrWetDays +IDL_Layer*RoadDensity_sqrt+IDL_Layer*PopDensity_log+IDL_Layer*DistUrbPop
               +IDL_Layer*I(TMax^2)+IDL_Layer*I(DTR^2)+IDL_Layer*I(fPAR^2)+I(LC_Tree^2) +IDL_Layer*I(LC_Shrub^2)+IDL_Layer*I(LC_Crop^2)+IDL_Layer*I(LC_Herbs^2)+IDL_Layer*I(Precipitation^2) +IDL_Layer*I(NrWetDays^2)
               +I(RoadDensity_sqrt^2)+I(PopDensity_log^2)+IDL_Layer*I(DistUrbPop^2)
)
...
#drop TMax                                 
ffix2<-formula(Ignitions~IDL_Layer*LC_Tree+IDL_Layer*LC_Shrub+IDL_Layer*LC_Herbs
               +IDL_Layer*DTR+IDL_Layer*fPAR+IDL_Layer*LC_Crop+IDL_Layer*Precipitation+IDL_Layer*NrWetDays +IDL_Layer*RoadDensity_sqrt+IDL_Layer*PopDensity_log+IDL_Layer*DistUrbPop
               +IDL_Layer*I(TMax^2)+IDL_Layer*I(DTR^2)+IDL_Layer*I(fPAR^2)+I(LC_Tree^2) +IDL_Layer*I(LC_Shrub^2)+IDL_Layer*I(LC_Crop^2)+IDL_Layer*I(LC_Herbs^2)+IDL_Layer*I(Precipitation^2) +IDL_Layer*I(NrWetDays^2)
               +I(RoadDensity_sqrt^2)+I(PopDensity_log^2)+IDL_Layer*I(DistUrbPop^2)
)
...
#drop PopDensity_log   
ffix3<-formula(Ignitions~IDL_Layer*LC_Tree+IDL_Layer*LC_Shrub+IDL_Layer*LC_Herbs
               +IDL_Layer*DTR+IDL_Layer*TMax+IDL_Layer*fPAR+IDL_Layer*LC_Crop+IDL_Layer*Precipitation+IDL_Layer*NrWetDays +IDL_Layer*RoadDensity_sqrt+IDL_Layer*DistUrbPop
               +IDL_Layer*I(TMax^2)+IDL_Layer*I(DTR^2)+IDL_Layer*I(fPAR^2)+I(LC_Tree^2) +IDL_Layer*I(LC_Shrub^2)+IDL_Layer*I(LC_Crop^2)+IDL_Layer*I(LC_Herbs^2)+IDL_Layer*I(Precipitation^2) +IDL_Layer*I(NrWetDays^2)
               +I(RoadDensity_sqrt^2)+I(PopDensity_log^2)+IDL_Layer*I(DistUrbPop^2)
)

Mfix.glswc3 <- lme(ffix3, data =Data, method="ML",
                   random = ~ 1 |GFED_Regions, weights = vf12 )
#compare AICs
AIC(Mfix.glswc, Mfix.glswc1,Mfix.glswc2,Mfix.glswc3)

#now that we found the model with the best random and fixed structure -> refit it with REML estimation
LME.final<-lme(ffix1, data =Data,
               random = ~ 1 |GFED_Regions, weights = vf12 ) 
LME.final.ML<-Mfix.glswc1
...
plot(LME.final)
#Make a histogram of the residuals to verify normality. 
plotNormalHistogram(residuals(LME.final))

#-> Homogenity and normality of the residuals looks very good and good respectively. Model with the best AIC as well
...
#get variable names
lme_names<- variable.names(lm(ffix1,data = Data))
#combine data
...
#set path
setwd("~/GitHub/GLM-Drivers-of-Fire/Output/Model Results")
saveRDS(M.glswc, "lmeBiome4Ignitions.rds")
...
sf<-formula(Ignitions~IDL_Layer+s(LC_Tree)+s(LC_Crop)+s(LC_Shrub)+s(LC_Herbs)
...
#set path
setwd("~/GitHub/GLM-Drivers-of-Fire/Output/Model Results")
saveRDS(GAM, "GAMBiome4Ignitions.rds")
#test<- readRDS("lmeBiome7.rds")
