...
Data<-GlobalDriversFire.dt[Year!=2016 & Biomes==7,]
...
#Correlations
#NrWetDays with Precipitation, PET with TMax, LAI and fPAR, drop PET and LAI and NrWetDays
...
f2<-formula(Ignitions~IDL_Layer*LC_Tree+IDL_Layer*LC_Shrub+IDL_Layer*LC_Herbs
            +IDL_Layer*DTR+IDL_Layer*TMax+IDL_Layer*fPAR+IDL_Layer*LC_Crop+IDL_Layer*Precipitation+IDL_Layer*RoadDensity_sqrt
            +IDL_Layer*PopDensity_log+IDL_Layer*DistUrbPop)

#linear model, considering quadratic terms
f<-formula(Ignitions~IDL_Layer*LC_Tree+IDL_Layer*LC_Shrub+IDL_Layer*LC_Herbs
           +IDL_Layer*DTR+IDL_Layer*TMax+IDL_Layer*fPAR+IDL_Layer*LC_Crop+IDL_Layer*Precipitation      +IDL_Layer*RoadDensity_sqrt+IDL_Layer*PopDensity_log+IDL_Layer*DistUrbPop
           +IDL_Layer*I(TMax^2)+IDL_Layer*I(DTR^2)+IDL_Layer*I(fPAR^2)+ IDL_Layer*I(LC_Tree^2) +IDL_Layer*I(LC_Shrub^2)+IDL_Layer*I(LC_Crop^2)+IDL_Layer*I(LC_Herbs^2)+IDL_Layer*I(Precipitation^2)
...
#-> Homogenity might be violated (trend in data), normality of the residuals looks not great either, no outliers

#save the complete model output
#set path
setwd("~/GitHub/GLM-Drivers-of-Fire/Output/Model Results")
saveRDS(LMfinal, "LMBiome7Ignitions.rds")
...
#as all terms are significant, no need for backward selection and refitting
LME.final<-M.glswc 
LME.final.ML<-Mfix.glswc
...
#get variable names
lme_names<- variable.names(lm(LM2,data = Data))
#combine data
...
#set path
setwd("~/GitHub/GLM-Drivers-of-Fire/Output/Model Results")
saveRDS(M.glswc, "lmeBiome7Ignitions.rds")
...
#set path
setwd("~/GitHub/GLM-Drivers-of-Fire/Output/Model Results")
saveRDS(GAM, "GAMBiome7Ignitions.rds")
#test<- readRDS("lmeBiome7.rds")
