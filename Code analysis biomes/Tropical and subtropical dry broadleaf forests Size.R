...
saveRDS(LMfinal, "LMBiome2Size.rds")
...
#all terms are significant enough, so that no meaningful improvement of the AIC is possible

#final model
LME.final.ML<-Mfix.glswc
#no need to refit it with REML estimation
LME.final <- M.glswc
...
#set path
setwd("~/GitHub/GLM-Drivers-of-Fire/Output/Model Results")
saveRDS(M.glswc, "lmeBiome2Size.rds")
