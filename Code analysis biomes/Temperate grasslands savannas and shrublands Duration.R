...
#-> Homogenity might be violated (trend in data), normality of the residuals looks ok but not great, no outliers

#save the complete model output
#set path
setwd("~/GitHub/GLM-Drivers-of-Fire/Output/Model Results")
saveRDS(LMfinal, "LMBiome8Duration.rds")
...
summary(M.glsw3)
plot(M.glsw3, main="M.glsw3")
#End find a good variance structure; homogenity looks good to ok now
...
M.glswc <- lme(f, data =Data,
               random = ~ 1 |GFED_Regions, weights = vf13 )
end_time <- Sys.time()
start_time-end_time

AIC(GLM,M.gls1,M.gls2,M.gls3,M.gls4,M.gls5,M.gls6,M.gls7, M.gls8, M.gls9, M.gls10, M.glsw3 ,M.glswc) #considerably better
summary(M.glswc)
...
#drop IDL_LayerNo_IDL:I(PopDensity_log^2) & IDL_LayerNo_IDL:I(Precipitation^2) & IDL_LayerNo_IDL:LC_Crop  & IDL_LayerNo_IDL:fPAR
ffix1<-formula(Duration~IDL_Layer*LC_Tree+IDL_Layer*LC_Shrub+IDL_Layer*LC_Herbs
               +IDL_Layer*DTR+IDL_Layer*TMax+fPAR+LC_Crop+IDL_Layer*Precipitation+IDL_Layer*NrWetDays +IDL_Layer*RoadDensity_sqrt+IDL_Layer*PopDensity_log+IDL_Layer*DistUrbPop
               +IDL_Layer*I(TMax^2)+IDL_Layer*I(DTR^2)+IDL_Layer*I(fPAR^2)+ IDL_Layer*I(LC_Tree^2) +IDL_Layer*I(LC_Shrub^2)+IDL_Layer*I(LC_Crop^2)+IDL_Layer*I(LC_Herbs^2)+I(Precipitation^2) +IDL_Layer*I(NrWetDays^2)
...
ffix2<-formula(Duration~IDL_Layer*LC_Tree+IDL_Layer*LC_Shrub+IDL_Layer*LC_Herbs
               +IDL_Layer*DTR+IDL_Layer*TMax+fPAR+LC_Crop+IDL_Layer*Precipitation +IDL_Layer*RoadDensity_sqrt+IDL_Layer*PopDensity_log+IDL_Layer*DistUrbPop
               +IDL_Layer*I(TMax^2)+IDL_Layer*I(DTR^2)+IDL_Layer*I(fPAR^2)+ IDL_Layer*I(LC_Tree^2) +IDL_Layer*I(LC_Shrub^2)+IDL_Layer*I(LC_Crop^2)+IDL_Layer*I(LC_Herbs^2)+I(Precipitation^2) +IDL_Layer*I(NrWetDays^2)
               +IDL_Layer*I(RoadDensity_sqrt^2)+I(PopDensity_log^2)+IDL_Layer*I(DistUrbPop^2)
)
...
#drop DTR
ffix3<-formula(Duration~IDL_Layer*LC_Tree+IDL_Layer*LC_Shrub+IDL_Layer*LC_Herbs
               +IDL_Layer*TMax+fPAR+LC_Crop+IDL_Layer*Precipitation+IDL_Layer*NrWetDays +IDL_Layer*RoadDensity_sqrt+IDL_Layer*PopDensity_log+IDL_Layer*DistUrbPop
               +IDL_Layer*I(TMax^2)+IDL_Layer*I(DTR^2)+IDL_Layer*I(fPAR^2)+ IDL_Layer*I(LC_Tree^2) +IDL_Layer*I(LC_Shrub^2)+IDL_Layer*I(LC_Crop^2)+IDL_Layer*I(LC_Herbs^2)+I(Precipitation^2) +IDL_Layer*I(NrWetDays^2)
               +IDL_Layer*I(RoadDensity_sqrt^2)+I(PopDensity_log^2)+IDL_Layer*I(DistUrbPop^2)
)
...
#-> Homogenity and normality of the residuals looks good/ok and ok respectively. Model with the best AIC as well
...
#set path
setwd("~/GitHub/GLM-Drivers-of-Fire/Output/Model Results")
saveRDS(M.glswc, "lmeBiome8Duration.rds")
...
#set path
setwd("~/GitHub/GLM-Drivers-of-Fire/Output/Model Results")
saveRDS(GAM, "GAMBiome8Duration.rds")
#test<- readRDS("lmeBiome7.rds")
