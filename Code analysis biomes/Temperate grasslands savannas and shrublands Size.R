...
library(rcompanion) # to plot normal hist
...
Data<-GlobalDriversFire.dt[Year!=2016 & Biomes==8,]
#We only want data were fires are actually possible, so no bare lands
plot(rasterFromXYZ(GlobalDriversFire.dt[,.(x, y,as.numeric(LC_Bare))]),main= "Fire Size ",col=mycolors)
Data<-Data[LC_Bare!=1]
...
colSums(Data!=0)
colSums(Data==0)
#plot some categorical variables and the response variable fire size
plot(rasterFromXYZ(Data[,.(x, y,as.numeric(Size))]),main= "Fire Size ",col=mycolors) 
plot(rasterFromXYZ(Data[,.(x, y,as.numeric(GFED_Regions))]),main= "Fire Size ",col=mycolors) 
plot(rasterFromXYZ(Data[,.(x, y,as.numeric(Continent))]),main= "Fire Size ",col=mycolors) 
plot(rasterFromXYZ(Data[,.(x, y,as.numeric(IDL_Layer))]),main= "Fire Size ",col=mycolors) 
#view fire size indigenous vs none indigenous land
plot(rasterFromXYZ(Data[IDL_Layer=="IDL",.(x, y,as.numeric(Size))]),main= "IDL ",col=mycolors)
plot(rasterFromXYZ(Data[IDL_Layer=="No_IDL",.(x, y,as.numeric(Size))]),main= "No IDL  ",col=mycolors)

#View histogram/distribution of response variable and transform if necessary
#Size
summary(Data$Size)
range(Data$Size)
hist(Data$Size) #right skewed
plotNormalHistogram(sqrt(Data$Size))
plotNormalHistogram(log(Data$Size))
plotNormalHistogram(log10(Data$Size))
Data$Size <- log(Data$Size)
plotNormalHistogram(Data$Size)
...
plot(Size~DTR)   
plot(Size~NrWetDays)
plot(Size~Precipitation)
plot(Size~PET) #pos linear
plot(Size~RoadDensity_sqrt)
plot(Size~PopDensity_log)
plot(Size~DistUrbPop) 
plot(Size~LC_Shrub) 
plot(Size~LC_Tree)  
plot(Size~LC_Crop)  
plot(Size~LC_Herbs) 
...
boxplot( Size ~ interaction(IDL_Layer,Month), data=Data )
boxplot( Size ~ interaction(IDL_Layer,Year), data=Data )
boxplot( Size ~ interaction(IDL_Layer,Continent), data=Data )
boxplot( Size ~ interaction(IDL_Layer,GFED_Regions), data=Data )
boxplot( Size ~ IDL_Layer, data=Data )
boxplot( Size ~ Month, data=Data )

#Check for correlations
cor(Data[,c(6:19,28)], use="pairwise.complete.obs")>0.7
#Correlations
#PET with TMax, LAI with fPAR, drop PET and LAI 
...
#1 linear model
f2<-formula(Size~IDL_Layer*LC_Tree+IDL_Layer*LC_Shrub+IDL_Layer*LC_Herbs
...
f<-formula(Size~IDL_Layer*LC_Tree+IDL_Layer*LC_Shrub+IDL_Layer*LC_Herbs
           +IDL_Layer*DTR+IDL_Layer*TMax+IDL_Layer*fPAR+IDL_Layer*LC_Crop+IDL_Layer*Precipitation+IDL_Layer*NrWetDays +IDL_Layer*RoadDensity_sqrt+IDL_Layer*PopDensity_log+IDL_Layer*DistUrbPop
...
saveRDS(LMfinal, "LMBiome8Size.rds")

#-> Homogenity might be violated, normality of the residuals looks good, no outliers
...
AIC(GLM,M.gls1,M.gls2,M.gls3,M.gls4,M.gls5,M.gls6,M.gls7, M.gls8, M.gls9, M.gls10, M.glsw2,M.glswc) #considerably better
summary(M.glswc)
...
#drop IDL_LayerNo IDL:LC_Crop & IDL_LayerNo IDL:LC_Shrub & IDL_LayerNo IDL:DTR
ffix1<-formula(Size~IDL_Layer*LC_Tree+LC_Shrub+IDL_Layer*LC_Herbs
                  +DTR+IDL_Layer*TMax+IDL_Layer*fPAR+LC_Crop+IDL_Layer*Precipitation+IDL_Layer*NrWetDays +IDL_Layer*RoadDensity_sqrt+IDL_Layer*PopDensity_log+IDL_Layer*DistUrbPop
                  +IDL_Layer*I(TMax^2)+IDL_Layer*I(DTR^2)+IDL_Layer*I(fPAR^2)+ IDL_Layer*I(LC_Tree^2) +IDL_Layer*I(LC_Shrub^2)+IDL_Layer*I(LC_Crop^2)+IDL_Layer*I(LC_Herbs^2)+IDL_Layer*I(Precipitation^2) +IDL_Layer*I(NrWetDays^2)+IDL_Layer*I(RoadDensity_sqrt^2)+IDL_Layer*I(PopDensity_log^2)+IDL_Layer*I(DistUrbPop^2)
)
...
summary(Mfix.glswc1)
#drop LC_Crop
ffix2<-formula(Size~IDL_Layer*LC_Tree+LC_Shrub+IDL_Layer*LC_Herbs
                  +DTR+IDL_Layer*TMax+IDL_Layer*fPAR+IDL_Layer*Precipitation+IDL_Layer*NrWetDays +IDL_Layer*RoadDensity_sqrt+IDL_Layer*PopDensity_log+IDL_Layer*DistUrbPop
                  +IDL_Layer*I(TMax^2)+IDL_Layer*I(DTR^2)+IDL_Layer*I(fPAR^2)+ IDL_Layer*I(LC_Tree^2) +IDL_Layer*I(LC_Shrub^2)+IDL_Layer*I(LC_Crop^2)+IDL_Layer*I(LC_Herbs^2)+IDL_Layer*I(Precipitation^2) +IDL_Layer*I(NrWetDays^2)+IDL_Layer*I(RoadDensity_sqrt^2)+IDL_Layer*I(PopDensity_log^2)+IDL_Layer*I(DistUrbPop^2)
)
...
#drop I(fPAR^2)
ffix3<-formula(Size~IDL_Layer*LC_Tree+LC_Shrub+IDL_Layer*LC_Herbs
               +DTR+IDL_Layer*TMax+IDL_Layer*fPAR+LC_Crop+IDL_Layer*Precipitation+IDL_Layer*NrWetDays +IDL_Layer*RoadDensity_sqrt+IDL_Layer*PopDensity_log+IDL_Layer*DistUrbPop
               +IDL_Layer*I(TMax^2)+IDL_Layer*I(DTR^2)+ IDL_Layer*I(LC_Tree^2) +IDL_Layer*I(LC_Shrub^2)+IDL_Layer*I(LC_Crop^2)+IDL_Layer*I(LC_Herbs^2)+IDL_Layer*I(Precipitation^2) +IDL_Layer*I(NrWetDays^2)+IDL_Layer*I(RoadDensity_sqrt^2)+IDL_Layer*I(PopDensity_log^2)+IDL_Layer*I(DistUrbPop^2)
)
...
#drop I(NrWetDays^2)
ffix4<-formula(Size~IDL_Layer*LC_Tree+LC_Shrub+IDL_Layer*LC_Herbs
               +DTR+IDL_Layer*TMax+IDL_Layer*fPAR+LC_Crop+IDL_Layer*Precipitation+IDL_Layer*NrWetDays +IDL_Layer*RoadDensity_sqrt+IDL_Layer*PopDensity_log+IDL_Layer*DistUrbPop
               +IDL_Layer*I(TMax^2)+IDL_Layer*I(DTR^2)+ IDL_Layer*I(LC_Tree^2) +IDL_Layer*I(LC_Shrub^2)+IDL_Layer*I(LC_Crop^2)+IDL_Layer*I(LC_Herbs^2)+IDL_Layer*I(Precipitation^2) +IDL_Layer*I(RoadDensity_sqrt^2)+IDL_Layer*I(PopDensity_log^2)+IDL_Layer*I(DistUrbPop^2)
)

Mfix.glswc4 <- lme(ffix4, data =Data, method="ML",
                   random = ~ 1 |GFED_Regions, weights = vf11 )

#compare AICs
AIC(Mfix.glswc, Mfix.glswc1,Mfix.glswc2,Mfix.glswc3,Mfix.glswc4)
...
LME.final <- lme(ffix1, data =Data, method="REML",
                   random = ~ 1 |GFED_Regions, weights = vf11 )
...
#-> Homogenity and normality of the residuals looks good. Model with the best AIC as well
...
#set path
setwd("~/GitHub/GLM-Drivers-of-Fire/Output/Model Results")
saveRDS(M.glswc, "lmeBiome8Size.rds")
...
sf<-formula(Size~IDL_Layer+s(LC_Tree)+s(LC_Crop)+s(LC_Shrub)+s(LC_Herbs)
