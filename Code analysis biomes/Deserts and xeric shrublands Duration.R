...
saveRDS(LMfinal, "LMBiome13Duration.rds")
...
#drop IDL_LayerNo_IDL:I(fPAR^2) & IDL_LayerNo_IDL:PopDensity_log 
ffix1<-formula(Duration~IDL_Layer*LC_Tree+IDL_Layer*LC_Shrub+IDL_Layer*LC_Herbs
               +IDL_Layer*DTR+IDL_Layer*TMax+IDL_Layer*fPAR+IDL_Layer*Precipitation+IDL_Layer*NrWetDays +IDL_Layer*RoadDensity_sqrt+PopDensity_log+IDL_Layer*DistUrbPop
...
#set path
setwd("~/GitHub/GLM-Drivers-of-Fire/Output/Model Results")
saveRDS(M.glswc, "lmeBiome13Duration.rds")
...
sf<-formula(Duration~IDL_Layer+s(LC_Tree)+s(LC_Shrub)+s(LC_Herbs)
...
#set path
setwd("~/GitHub/GLM-Drivers-of-Fire/Output/Model Results")
saveRDS(GAM, "GAMBiome13Duration.rds")
#test<- readRDS("lmeBiome7.rds")
