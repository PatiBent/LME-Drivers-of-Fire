...
saveRDS(LMfinal, "LMBiome4Duration.rds")
...
#drop IDL_LayerNo_IDL:I(DistUrbPop^2) & IDL_LayerNo_IDL:I(PopDensity_log^2 & IDL_LayerNo_IDL:I(RoadDensity_sqrt^2) & IDL_LayerNo_IDL:I(NrWetDays^2) & IDL_LayerNo_IDL:I(Precipitation^2) & IDL_LayerNo_IDL:I(TMax^2) & IDL_LayerNo_IDL:RoadDensity_sqrt    
ffix1<-formula(Duration~IDL_Layer*LC_Tree+IDL_Layer*LC_Shrub+IDL_Layer*LC_Herbs
               +IDL_Layer*DTR+IDL_Layer*TMax+IDL_Layer*fPAR+IDL_Layer*LC_Crop+IDL_Layer*Precipitation+IDL_Layer*NrWetDays +RoadDensity_sqrt+IDL_Layer*PopDensity_log+IDL_Layer*DistUrbPop
               +I(TMax^2)+IDL_Layer*I(DTR^2)+IDL_Layer*I(fPAR^2)+ IDL_Layer*I(LC_Tree^2) +IDL_Layer*I(LC_Shrub^2)+IDL_Layer*I(LC_Crop^2)+IDL_Layer*I(LC_Herbs^2)+I(Precipitation^2) +I(NrWetDays^2)
               +I(RoadDensity_sqrt^2)+I(PopDensity_log^2)+I(DistUrbPop^2)
)
...
ffix2<-formula(Duration~IDL_Layer*LC_Tree+IDL_Layer*LC_Shrub+IDL_Layer*LC_Herbs
               +IDL_Layer*DTR+IDL_Layer*TMax+IDL_Layer*fPAR+IDL_Layer*LC_Crop+IDL_Layer*Precipitation+IDL_Layer*NrWetDays +RoadDensity_sqrt+IDL_Layer*PopDensity_log+IDL_Layer*DistUrbPop
               +I(TMax^2)+IDL_Layer*I(DTR^2)+IDL_Layer*I(fPAR^2)+ IDL_Layer*I(LC_Tree^2)+IDL_Layer*I(LC_Crop^2)+IDL_Layer*I(LC_Herbs^2)+I(Precipitation^2) +I(NrWetDays^2)
               +I(RoadDensity_sqrt^2)+I(PopDensity_log^2)+I(DistUrbPop^2)
)
...
ffix3<-formula(Duration~IDL_Layer*LC_Tree+IDL_Layer*LC_Shrub+IDL_Layer*LC_Herbs
               +IDL_Layer*DTR+IDL_Layer*TMax+IDL_Layer*LC_Crop+IDL_Layer*Precipitation+IDL_Layer*NrWetDays +RoadDensity_sqrt+IDL_Layer*PopDensity_log+IDL_Layer*DistUrbPop
               +I(TMax^2)+IDL_Layer*I(DTR^2)+IDL_Layer*I(fPAR^2)+ IDL_Layer*I(LC_Tree^2) +IDL_Layer*I(LC_Shrub^2)+IDL_Layer*I(LC_Crop^2)+IDL_Layer*I(LC_Herbs^2)+I(Precipitation^2) +I(NrWetDays^2)
               +I(RoadDensity_sqrt^2)+I(PopDensity_log^2)+I(DistUrbPop^2)
)
...
#set path
setwd("~/GitHub/GLM-Drivers-of-Fire/Output/Model Results")
saveRDS(M.glswc, "lmeBiome4Duration.rds")
...
#set path
setwd("~/GitHub/GLM-Drivers-of-Fire/Output/Model Results")
saveRDS(GAM, "GAMBiome4Duration.rds")
#test<- readRDS("lmeBiome7.rds")
