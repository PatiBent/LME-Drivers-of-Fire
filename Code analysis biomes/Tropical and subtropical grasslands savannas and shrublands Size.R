...
saveRDS(LMfinal, "LMBiome7Size.rds")
...
AIC(GLM,M.gls1,M.gls2,M.gls3,M.gls4,M.gls5,M.gls6,M.gls7, M.gls8, M.gls9, M.gls10, M.glsw,  M.glsw2)
...
#all terms are significant, so not backward selection needed
...
#get variable names
lme_names<- variable.names(lm(f,data = Data))
#combine data
...
#set path
setwd("~/GitHub/GLM-Drivers-of-Fire/Output/Model Results")
saveRDS(M.glswc, "lmeBiome7Size.rds")
