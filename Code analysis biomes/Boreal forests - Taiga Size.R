...
saveRDS(LMfinal, "LMBiome6Size.rds")
...
#drop IDL_LayerNo_IDL:I(DistUrbPop^2) & IDL_LayerNo_IDL:I(PopDensity_log^2) & IDL_LayerNo_IDL:DistUrbPop  
ffix1<-formula(Size~IDL_Layer*LC_Tree+IDL_Layer*LC_Shrub+IDL_Layer*LC_Herbs
               ...
               +IDL_Layer*I(TMax^2)+IDL_Layer*I(DTR^2)+IDL_Layer*I(fPAR^2)+ IDL_Layer*I(LC_Tree^2) +IDL_Layer*I(LC_Shrub^2)+IDL_Layer*I(LC_Crop^2)+IDL_Layer*I(LC_Herbs^2)+IDL_Layer*I(Precipitation^2) +IDL_Layer*I(NrWetDays^2)
               +IDL_Layer*I(RoadDensity_sqrt^2)+I(PopDensity_log^2)+I(DistUrbPop^2)
)
...
ffix2<-formula(Size~IDL_Layer*LC_Tree+IDL_Layer*LC_Shrub+IDL_Layer*LC_Herbs
               +IDL_Layer*DTR+IDL_Layer*TMax+IDL_Layer*fPAR+IDL_Layer*LC_Crop+IDL_Layer*Precipitation+IDL_Layer*NrWetDays +IDL_Layer*RoadDensity_sqrt+IDL_Layer*PopDensity_log+DistUrbPop
               +IDL_Layer*I(TMax^2)+IDL_Layer*I(fPAR^2)+ IDL_Layer*I(LC_Tree^2) +IDL_Layer*I(LC_Shrub^2)+IDL_Layer*I(LC_Crop^2)+IDL_Layer*I(LC_Herbs^2)+IDL_Layer*I(Precipitation^2) +IDL_Layer*I(NrWetDays^2)
               +IDL_Layer*I(RoadDensity_sqrt^2)+I(PopDensity_log^2)+I(DistUrbPop^2)
)
...
#set path
setwd("~/GitHub/GLM-Drivers-of-Fire/Output/Model Results")
saveRDS(M.glswc, "lmeBiome6Size.rds")
