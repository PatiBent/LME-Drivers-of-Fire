...
#1 linear model
f2<-formula(Size~IDL_Layer*LC_Tree+IDL_Layer*LC_Shrub+IDL_Layer*LC_Herbs+IDL_Layer*PET
...
f<-formula(Size~IDL_Layer*LC_Tree+IDL_Layer*LC_Shrub+IDL_Layer*LC_Herbs+IDL_Layer*PET
           +IDL_Layer*DTR+IDL_Layer*TMax+IDL_Layer*fPAR+IDL_Layer*LC_Crop+IDL_Layer*Precipitation+IDL_Layer*NrWetDays +IDL_Layer*RoadDensity_sqrt+IDL_Layer*PopDensity_log+IDL_Layer*DistUrbPop
...
saveRDS(LMfinal, "LMBiome1Size.rds")

#-> Homogenity does not look good at all might be violated, normality of the residuals looks good, no outliers
...
M.glsw5 <- gls(f, data =Data,
               weights = vf15)



AIC(GLM,M.gls1,M.gls2,M.gls3,M.gls4,M.gls5,M.gls6,M.gls7, M.gls8, M.gls9, M.gls10, M.glsw, M.glsw2, M.glsw3,M.glsw4,M.glsw5,M.glsw6)

#check homogeneity of variance again
summary(M.glsw5)
plot(M.glsw5, main="M.glsw5")


#End find a good variance structure; homogenity looks way better and ok to good now
...
M.glswc <- lme(f, data =Data,
               random = ~ 1 |GFED_Regions, weights = vf15)
end_time <- Sys.time()
start_time-end_time

AIC(GLM,M.gls1,M.gls2,M.gls3,M.gls4,M.gls5,M.gls6,M.gls7, M.gls8, M.gls9, M.gls10, M.glsw5,M.glswc) #considerably better
summary(M.glswc)
summary(M.glsw4)
plot(M.glswc)
...
ffix1<-formula(Size~LC_Tree+IDL_Layer*LC_Shrub+IDL_Layer*LC_Herbs+IDL_Layer*PET
               +IDL_Layer*DTR+IDL_Layer*TMax+IDL_Layer*fPAR+IDL_Layer*LC_Crop+IDL_Layer*Precipitation+IDL_Layer*NrWetDays +IDL_Layer*RoadDensity_sqrt+IDL_Layer*PopDensity_log+IDL_Layer*DistUrbPop
               +IDL_Layer*I(TMax^2)+IDL_Layer*I(DTR^2)+IDL_Layer*I(fPAR^2)+ IDL_Layer*I(LC_Tree^2) +IDL_Layer*I(LC_Shrub^2)+IDL_Layer*I(LC_Crop^2)+IDL_Layer*I(LC_Herbs^2)+IDL_Layer*I(Precipitation^2) +IDL_Layer*I(NrWetDays^2)+IDL_Layer*I(PET^2)
               +IDL_Layer*I(RoadDensity_sqrt^2)+IDL_Layer*I(PopDensity_log^2)+IDL_Layer*I(DistUrbPop^2)
)
...
#drop I(LC_Shrub^2)
ffix2<-formula(Size~LC_Tree+IDL_Layer*LC_Shrub+IDL_Layer*LC_Herbs+IDL_Layer*PET
               +IDL_Layer*DTR+IDL_Layer*TMax+IDL_Layer*fPAR+IDL_Layer*LC_Crop+IDL_Layer*Precipitation+IDL_Layer*NrWetDays +IDL_Layer*RoadDensity_sqrt+IDL_Layer*PopDensity_log+IDL_Layer*DistUrbPop
               +IDL_Layer*I(TMax^2)+IDL_Layer*I(DTR^2)+IDL_Layer*I(fPAR^2)+ IDL_Layer*I(LC_Tree^2) +IDL_Layer*I(LC_Crop^2)+IDL_Layer*I(LC_Herbs^2)+IDL_Layer*I(Precipitation^2) +IDL_Layer*I(NrWetDays^2)+IDL_Layer*I(PET^2)
               +IDL_Layer*I(RoadDensity_sqrt^2)+IDL_Layer*I(PopDensity_log^2)+IDL_Layer*I(DistUrbPop^2)
)

Mfix.glswc3 <- lme(ffix2, data =Data, method="ML",
                   random = ~ 1 |GFED_Regions, weights = vf15 )
#compare AICs
...
#set path
setwd("~/GitHub/GLM-Drivers-of-Fire/Output/Model Results")
saveRDS(M.glswc, "lmeBiome1Size.rds")
...
sf<-formula(Size~IDL_Layer+s(LC_Tree)+s(LC_Crop)+s(LC_Shrub)+s(LC_Herbs)
            +s(DTR)+s(TMax)+s(Precipitation)+s(NrWetDays)+s(PET)
