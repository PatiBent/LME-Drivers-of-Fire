...
#1 linear model
f2<-formula(Fire~IDL_Layer*LC_Tree+IDL_Layer*LC_Shrub+IDL_Layer*LC_Herbs+IDL_Layer*LC_Crop
...
f<-formula(Fire~IDL_Layer*LC_Tree+IDL_Layer*LC_Shrub+IDL_Layer*LC_Herbs+IDL_Layer*LC_Crop
           +IDL_Layer*DTR+IDL_Layer*TMax+IDL_Layer*fPAR+IDL_Layer*Precipitation+IDL_Layer*NrWetDays +IDL_Layer*RoadDensity_sqrt+IDL_Layer*PopDensity_log+IDL_Layer*DistUrbPop
           +IDL_Layer*I(TMax^2)+IDL_Layer*I(DTR^2)+IDL_Layer*I(fPAR^2)+ IDL_Layer*I(LC_Tree^2)+IDL_Layer*I(LC_Crop^2) +IDL_Layer*I(LC_Shrub^2)+IDL_Layer*I(LC_Herbs^2)+IDL_Layer*I(Precipitation^2) +IDL_Layer*I(NrWetDays^2)
...
#all terms are significant, no need to drop any
#drop NrWetDays   
