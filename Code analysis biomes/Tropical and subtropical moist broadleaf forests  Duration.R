...
#1 linear model
f2<-formula(Duration~IDL_Layer*LC_Tree+IDL_Layer*LC_Shrub+IDL_Layer*LC_Herbs+IDL_Layer*PET
...
f<-formula(Duration~IDL_Layer*LC_Tree+IDL_Layer*LC_Shrub+IDL_Layer*LC_Herbs+IDL_Layer*PET
           +IDL_Layer*DTR+IDL_Layer*TMax+IDL_Layer*fPAR+IDL_Layer*LC_Crop+IDL_Layer*Precipitation+IDL_Layer*NrWetDays +IDL_Layer*RoadDensity_sqrt+IDL_Layer*PopDensity_log+IDL_Layer*DistUrbPop
...
#Lets drop the outliers and fit the lienar model again
Data<-Data[-c(244465,243891,315148,243890,273783),]
...
saveRDS(LMfinal, "LMBiome1Duration.rds")
...
summary(M.glsw2)
plot(M.glsw2, main="M.glsw2")
#End find a good variance structure; homogenity looks ok (not great)
...
#drop IDL_LayerNo_IDL:I(LC_Herbs^2)  & IDL_LayerNo_IDL:fPAR
ffix1<-formula(Duration~IDL_Layer*LC_Tree+IDL_Layer*LC_Shrub+IDL_Layer*LC_Herbs+IDL_Layer*PET
               +IDL_Layer*DTR+IDL_Layer*TMax+fPAR+IDL_Layer*LC_Crop+IDL_Layer*Precipitation+IDL_Layer*NrWetDays +IDL_Layer*RoadDensity_sqrt+IDL_Layer*PopDensity_log+IDL_Layer*DistUrbPop
               +IDL_Layer*I(TMax^2)+IDL_Layer*I(DTR^2)+IDL_Layer*I(fPAR^2)+ IDL_Layer*I(LC_Tree^2) +IDL_Layer*I(LC_Shrub^2)+IDL_Layer*I(LC_Crop^2)+I(LC_Herbs^2)+IDL_Layer*I(Precipitation^2) +IDL_Layer*I(NrWetDays^2)+IDL_Layer*I(PET^2)
               +IDL_Layer*I(RoadDensity_sqrt^2)+IDL_Layer*I(PopDensity_log^2)+IDL_Layer*I(DistUrbPop^2)
)
...
#drop I(PopDensity_log^2) 
ffix2<-formula(Duration~IDL_Layer*LC_Tree+IDL_Layer*LC_Shrub+IDL_Layer*LC_Herbs+IDL_Layer*PET
               +IDL_Layer*DTR+IDL_Layer*TMax+fPAR+IDL_Layer*LC_Crop+IDL_Layer*Precipitation+IDL_Layer*NrWetDays +IDL_Layer*RoadDensity_sqrt+IDL_Layer*PopDensity_log+IDL_Layer*DistUrbPop
               +IDL_Layer*I(TMax^2)+IDL_Layer*I(DTR^2)+IDL_Layer*I(fPAR^2)+ IDL_Layer*I(LC_Tree^2) +IDL_Layer*I(LC_Shrub^2)+IDL_Layer*I(LC_Crop^2)+I(LC_Herbs^2)+IDL_Layer*I(Precipitation^2) +IDL_Layer*I(NrWetDays^2)+IDL_Layer*I(PET^2)
              +IDL_Layer*I(RoadDensity_sqrt^2)+IDL_Layer*I(DistUrbPop^2)
)
...
#drop I(TMax^2) 
ffix3<-formula(Duration~IDL_Layer*LC_Tree+IDL_Layer*LC_Shrub+IDL_Layer*LC_Herbs+IDL_Layer*PET
               +IDL_Layer*DTR+IDL_Layer*TMax+fPAR+IDL_Layer*LC_Crop+IDL_Layer*Precipitation+IDL_Layer*NrWetDays +IDL_Layer*RoadDensity_sqrt+IDL_Layer*PopDensity_log+IDL_Layer*DistUrbPop
               +IDL_Layer*I(DTR^2)+IDL_Layer*I(fPAR^2)+ IDL_Layer*I(LC_Tree^2) +IDL_Layer*I(LC_Shrub^2)+IDL_Layer*I(LC_Crop^2)+I(LC_Herbs^2)+IDL_Layer*I(Precipitation^2) +IDL_Layer*I(NrWetDays^2)+IDL_Layer*I(PET^2)+IDL_Layer*I(PopDensity_log^2)
               +IDL_Layer*I(RoadDensity_sqrt^2)+IDL_Layer*I(DistUrbPop^2)
)
...
#-> Homogenity and normality of the residuals looks ok. Model with the best AIC as well
...
#set path
setwd("~/GitHub/GLM-Drivers-of-Fire/Output/Model Results")
saveRDS(M.glswc, "lmeBiome1Duration.rds")
...
#set path
setwd("~/GitHub/GLM-Drivers-of-Fire/Output/Model Results")
saveRDS(GAM, "GAMBiome1Duration.rds")
#test<- readRDS("lmeBiome7.rds")
